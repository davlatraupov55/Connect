...
class ChangePIN2Screen extends React.Component{
...
<Text style={{color: '#858585', fontSize: width/27, marginBottom: height/70, fontWeight: '700', left: width/3.5}} ></Text>    
...
export default ChangePIN2Screen;