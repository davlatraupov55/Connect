...
class Statement1CheckScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default Statement1CheckScreen;