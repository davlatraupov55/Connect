...
class Statement1Screen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
<Text style={{left: width/-30, fontSize: width/25, color: 'black',fontWeight: '600', marginTop: height/55, opacity: 0.8, width: width/1.2, marginBottom: height/30}} >Заявление на выезд из общежития</Text>
...
<View style={{flexDirection: 'row', left: width/1.2}} >
<Text style={{fontSize: width/27, color: '#606060', fontWeight: '600', marginTop: height/35, opacity: 0.8, width: width/1, marginBottom: height/50}} >Причина выезда</Text>
<TextInput style={{height: height/20, width: width/1.6, left: width/-1.45, borderBottomColor: 'grey', borderBottomWidth: 1, marginTop: height/550, fontSize: width/23, paddingBottom: height/-50}} placeholder={'введите причина выезда'}  />
</View>
...
export default Statement1Screen;