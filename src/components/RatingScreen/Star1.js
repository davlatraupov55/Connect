...
function Star1 (props) {
    ...
    return(
        ...
        return(
            <Image source={require('../../img/star1.png')} style={{height: height/20, width: height/20, marginRight: width/50}} /> 
        )
        }
        else if (props.data == 2){
            return(
                <Image source={require('../../img/star2.png')} style={{height: height/20, width: height/20, marginRight: width/50}} /> 
            )
            }
